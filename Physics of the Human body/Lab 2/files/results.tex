...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \begin{axis} [
            ...
            \draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (axis cs:12.3,125) -- ++ (-1,-55) node [right, black,midway,xshift=0.4cm] {After approx. 2 min rest};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \begin{axis} [
            ...
            \draw [dashed] (8,0) -- (8,180);
            \draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (axis cs:12.3,96) -- ++ (-1,-28) node [right, black,midway,xshift=0.4cm] {After approx. 2 min rest};
        \end{axis}
    \end{tikzpicture}
